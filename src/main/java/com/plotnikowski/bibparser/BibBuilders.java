    ...
    public static BibBuilder[] getDefaultBuilders() {
        return new BibBuilder[]{
                new BibBuilder("ARTICLE", BibFieldNames.createArray("author, title, journal, year"),
                        BibFieldNames.createArray("volume, number, pages, month, note, key, crossref")),

                new BibBuilder("BOOK", BibFieldNames.createArray("author|editor, title, publisher, year"),
                        BibFieldNames.createArray("volume, series, address, edition, month, note, key, crossref")),

                new BibBuilder("INPROCEEDINGS", BibFieldNames.createArray("author, title, booktitle, year"),
                        BibFieldNames.createArray("editor, volume|number, series, pages, address, month, organization, publisher, note, key, crossref")),

                new BibBuilder("BOOKLET", BibFieldNames.createArray("title"),
                        BibFieldNames.createArray("author, howpublished, address, month, year, note, key, crossref")),

                new BibBuilder("INBOOK", BibFieldNames.createArray("author|editor, title, chapter|pages, publisher, year"),
                        BibFieldNames.createArray("volume|number, series, type, address, edition, month, note, key, crossref")),

                new BibBuilder("INCOLLECTION", BibFieldNames.createArray("author, title, booktitle, publisher, year"),
                        BibFieldNames.createArray("editor, volume|number, series, type, chapter, pages, address, edition, month, note, key, crossref")),

                new BibBuilder("MANUAL", BibFieldNames.createArray("title"),
                        BibFieldNames.createArray("author, organization, address, edition, month, year, note, key, crossref")),
                ...
                new BibBuilder("MISC", new BibFieldNames[0],
                        BibFieldNames.createArray("author, title, howpublished, month, year, note, key, crossref")),

                new BibBuilder("UNPUBLISHED", BibFieldNames.createArray("author, title, note"),
                        BibFieldNames.createArray("month, year, key, crossref")),
        };
    }
}
